...
export function Header() {
    ...
    const pageState: PageState = useSelector((state: RootState)=> state.pageState);
                                    ...
                                    {Object.entries(PageState).map(([key,value])=>{
                                        return (
                                            <Nav.Link 
                                                ...
                                                onClick={()=>{dispatch(Action.changePage(value))}}
                                        >
                                           {key}
                                        </Nav.Link> 
                                        )
